  ...
  const renderCategoryOptions = (
    ...
    return categories
      ...
      .flatMap((category) => {
        ...
        const isDisabled = category.hasIssues || (parentId !== null && category.hasSubCategories);
        ...
        // Recursively render subcategory options with increased indentation
        const subcategoryOptions = renderCategoryOptions(
