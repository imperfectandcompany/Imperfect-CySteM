import { ContentElement, HeaderElement, ParagraphElement, ImageElement, ListElement, CodeBlockElement, AccordionElement, AchievementElement, AchievementUnlocksElement, AdminCommandElement, AlertElement, BugTrackerElement, CardElement, CarouselElement, ChangelogElement, CodeElement, CommunitySpotlightElement, CountdownElement, CustomCommandsElement, DataVisualizationElement, EventLogElement, FaqElement, FeatureElement, GalleryElement, InfoCardElement, LeaderboardElement, MediaGalleryElement, ModalElement, ModerationActionsElement, NeutralAlertElement, NewMapElement, PatchNotesElement, PlayerCommandElement, ProgressElement, RankingPointsElement, RankingSystemElement, ServerInfoElement, ServerPerformanceElement, ServerRulesElement, ServerScheduleElement, SpacingElement, StatsElement, SteamProfileElement, TabElement, TableElement, TestimonialElement, TextStyleElement, WarningAlertElement, YoutubeElement } from './contentTypes';
    ...
    lines.forEach((line, index) => {
        ...
        switch (type) {
            ...
            case 'paragraph':
                ...
                break;
            case 'image':
                elements.push({ type: 'image', url: content, alt: style, id: `image-${index}` } as ImageElement);
                break;
            case 'list':
